...
class FishingLevel {
	...
	public static function getProgress(int $progress, int $size): string {
		...
		return TextFormat::DARK_GRAY . "[" . TextFormat::GREEN . str_repeat("|", $progress) .
			TextFormat::GRAY . str_repeat("|", $size - $progress) . TextFormat::DARK_GRAY . "] " .
			TextFormat::YELLOW . "{$percentage} %%";
	}
