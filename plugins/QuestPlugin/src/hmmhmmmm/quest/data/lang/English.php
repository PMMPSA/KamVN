...
class English{
   ...
   public static function init(): array{
      return [
         ...
         "questmanager.eventlist.breakblock" => "Phá vỡ khối",
         "questmanager.eventlist.placeblock" => "Đặt khối",
         "questmanager.eventlist.kill_entity" => "Giết sinh vật",
         "questmanager.eventlist.kill_player" => "Giết người chơi",
         ...
         "questmanager.start.complete" => "§d%1 §fhoàn thành nhiệm vụ §e%2 §fand có giải thưởng %3",
         ...
         "command.add.complete2" => "Bạn đã nhận được nhiệm vụ §a%1",
