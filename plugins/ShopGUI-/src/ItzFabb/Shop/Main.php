...
class Main extends PluginBase implements Listener{
	...
	public function shop($sender)
	{
	    ...
	    $this->menu->setListener([$this, "shopmenu"]);
         $this->menu->setName("§0( Tạp Hoá )");
	    $inventory = $this->menu->getInventory();
	    
	    //Chest Section 1-8
	    $inventory->setItem(0, Item::get(160, 9, 1)->setCustomName(" §r §7 §r "));
	    $inventory->setItem(1, Item::get(160, 8, 1)->setCustomName(" §r §7 §r "));
	    $inventory->setItem(2, Item::get(1, 0, 1)->setCustomName("§r§e§l§nCửa hàng block"));
	    $inventory->setItem(3, Item::get(160, 8, 1)->setCustomName(" §r §7 §r "));
	    $inventory->setItem(4, Item::get(47, 0, 1)->setCustomName("§r§e§l§nCửa hàng đồ trang trí"));
	    $inventory->setItem(5, Item::get(160, 8, 1)->setCustomName(" §r §7 §r "));
	    $inventory->setItem(6, Item::get(170, 0, 1)->setCustomName("§r§e§l§nCửa hàng nông trại"));
	    $inventory->setItem(7, Item::get(160, 8, 1)->setCustomName(" §r §7 §r "));
         ...
         $inventory->setItem(12, Item::get(268, 0, 1)->setCustomName("§r§e§l§nCửa hàng công cụ"));
         $inventory->setItem(13, Item::get(160, 8, 1)->setCustomName(" §r §7 §r "));
         $inventory->setItem(14, Item::get(351, 1, 1)->setCustomName("§r§e§l§nCửa hàng thuốc nhuộm"));
         ...
         $inventory->setItem(20, Item::get(289, 0, 1)->setCustomName("§r§e§l§nCửa hàng lồng spawn"));
	    ...
	    $inventory->setItem(24, Item::get(264, 0, 1)->setCustomName("§r§e§l§nCửa hàng quặng"));
	    ...
	    $inventory->setItem(29, Item::get(297, 0, 1)->setCustomName("§r§e§l§nCửa hàng đồ ăn"));
	    $inventory->setItem(30, Item::get(160, 8, 1)->setCustomName(" §r §7 §r "));
	    $inventory->setItem(31, Item::get(35, 0, 1)->setCustomName("§r§e§l§nCửa hàng gỗ"));
	    $inventory->setItem(32, Item::get(160, 8, 1)->setCustomName(" §r §7 §r "));
	    $inventory->setItem(33, Item::get(20, 0, 1)->setCustomName("§r§e§l§nShop kính"));
	    $inventory->setItem(34, Item::get(160, 8, 1)->setCustomName(" §r §7 §r "));
         ...
         $inventory->setItem(39, Item::get(236, 0, 1)->setCustomName("§r§e§l§nCửa hàng bê tông"));
         $inventory->setItem(40, Item::get(160, 8, 1)->setCustomName(" §r §7 §r "));
         $inventory->setItem(41, Item::get(373, 1, 1)->setCustomName("§r§e§lCửa hàng thuốc"));
	    ...
	    $inventory->setItem(49, Item::get(152, 0, 1)->setCustomName("§r§c§lQuay lại\n§r§7Click to exit the shop menu"));
	...
	public function shopmenu(Player $sender, Item $item){
	   $hand = $sender->getInventory()->getItemInHand()->getCustomName();
        ...
        if($item->getId() == 373 && $item->getDamage() == 1){
        	$sender->removeWindow($inventory);
        	$sender->sendMessage("§8[§e Cửa hàng§8]");
        	$sender->getLevel()->broadcastLevelSoundEvent($sender->add(0, $sender->eyeHeight, 0), LevelSoundEventPacket::SOUND_CHEST_OPEN);
        }
	}
	/**
	 ...
	 public function concretes($sender)
	 {
        ...
        if($item->getId() == 236 && $item->getDamage() == 15){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Black Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	     }
        }
        if($item->getId() == 236 && $item->getDamage() == 14){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Red Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 13){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Green Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 12){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Brown Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 11){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Blue Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 10){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Purple Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 9){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cyan Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 8){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Gray Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 7){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gray Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 6){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pink Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 5){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Lime Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 4){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Yellow Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 3){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Blue Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 2){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Magenta Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 1){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Orange Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 0){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x White Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 15){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Black Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 14){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Red Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 13){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Green Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 12){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Brown Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 11){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Blue Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 10){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Purple Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 9){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cyan Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 8){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Gray Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 7){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gray Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 6){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pink Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 5){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Lime Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 4){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Yellow Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 3){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Blue Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 2){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Magenta Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 1){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Orange Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 237 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x White Powder Concrete§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
       ...
       if($item->getId() == 152 && $item->getDamage() == 0){
        ...
        if($item->getId() == 241 && $item->getDamage() == 15){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Black Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 14){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Red Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 13){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Green Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 12){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Brown Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 11){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Blue Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 10){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Purple Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 9){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cyan Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 8){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Gray Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 7){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gray Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 6){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pink Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 5){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Lime Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 4){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Yellow Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 3){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Blue Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 2){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Magenta Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 1){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Orange Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 241 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x White Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 15){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Black Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 14){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Red Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 13){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Green Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 12){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Brown Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 11){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Blue Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 10){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Purple Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 9){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cyan Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 8){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Gray Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 7){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gray Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 6){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pink Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 5){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Lime Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 4){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Yellow Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 3){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Blue Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 2){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Magenta Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 1){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Orange Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 160 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x White Stained Glass§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	 ...
	 public function wools($sender)
	 {
        ...
        if($item->getId() == 35 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x White Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 1){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Orange Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 2){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Magenta Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 3){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Blue Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 4){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Yellow Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 5){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Lime Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 6){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pink Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 7){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gray Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 8){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Gray Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 9){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cyan Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 10){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Purple Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 11){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Blue Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 12){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Brown Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 13){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Green Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 14){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Red Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 35 && $item->getDamage() == 15){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Black Wool§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x White Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 1){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Orange Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 2){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Magenta Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 3){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Blue Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 4){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Yellow Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 5){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Lime Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 6){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pink Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 7){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gray Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 8){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Gray Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 9){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cyan Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 10){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Purple Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 11){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Blue Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 12){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Brown Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 13){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Green Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 14){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Red Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 171 && $item->getDamage() == 15){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Black Carpet§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
       ...
       if($item->getId() == 152 && $item->getDamage() == 0){
        ...
        if($item->getId() == 446 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Black Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 1){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Red Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 2){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Green Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 3){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Brown Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 4){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Blue Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 5){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Purple Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 6){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cyan Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 7){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Gray Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 8){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gray Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 9){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pink Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 10){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Lime Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 11){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Yellow Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 12){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Blue Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 13){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Magenta Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 14){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Orange Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 446 && $item->getDamage() == 15){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x White Banner§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	 ...
	 public function foods($sender)
	 {
        ...
        if($item->getId() == 363 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Raw Beef§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	     }
        }
        if($item->getId() == 364 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cooked Beef§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 365 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Raw Chicken§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 354 && $item->getDamage() == 0){
	        ...
	        if($money >= 35){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cake§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 366 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cooked Chicken§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 319 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Raw Porkchop§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 320 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cooked Porkchop§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 411 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Raw Rabbit§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 412 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cooked Rabbit§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 423 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Raw Mutton§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 424 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cooked Mutton§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 357 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cookie§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 463 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cooked Salmon§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 350 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cooked Cod§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 393 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Baked Potato§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 282 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Mushroom Stew§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 413 && $item->getDamage() == 0){
	        ...
	        if($money >= 15){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Rabbit Stew§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 459 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Beetroot Soup§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 396 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Golden Carrot§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 297 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Bread§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua foods!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	 ...
	 public function ores($sender)
	 {
        ...
        if($item->getId() == 16 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Coal Ore§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	     }
        }
        if($item->getId() == 56 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diamond Ore§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 129 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Emerald Ore§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 14 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gold Ore§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 15 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Iron Ore§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 21 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Lapis Ore§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 73 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Redstone Ore§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 263 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Coal§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 264 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diamond§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 388 && $item->getDamage() == 0){
	        ...
	        if($money >= 75){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Emerald§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 266 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gold Ingot§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 265 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Iron Ingot§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 4){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Lapis Lazuli§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 331 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Redstone§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 173 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Block of Coal§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 57 && $item->getDamage() == 0){
	        ...
	        if($money >= 500){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Block of Diamond§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 133 && $item->getDamage() == 0){
	        ...
	        if($money >= 1000){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Block of Emerald§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 41 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Block of Gold§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 42 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Block of Iron§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 22 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Block of Lapis§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 152 && $item->getDamage() == 0){
	        ...
	        if($money >= 15){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Block of Redstone§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua ore!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	 ...
	 public function mobsdrops($sender)
	 {
        ...
        public function mobsdropsshop(Player $sender, Item $item){
	     ...
	     $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_CLICK, (int) $volume);
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Arrow§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 377 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Blaze Powder§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 369 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Blaze§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 352 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Bone§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 368 && $item->getDamage() == 0){
	        ...
	        if($money >= 45){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Ender Pearl§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 288 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Feather§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 370 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Ghast Tear§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 289 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gunpowder§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 334 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Leather§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 378 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Magma Cream§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 414 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Rabbit Foot§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 415 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Rabbit Hide§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 367 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Rotten Flesh§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 287 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x String§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 375 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Spider Eye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 344 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Egg§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 341 && $item->getDamage() == 0){
	        ...
	        if($money >= 7){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Slime Ball§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	 ...
	 public function dyes($sender)
	 {
        ...
        if($item->getId() == 351 && $item->getDamage() == 1){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Red Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 2){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Green Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 5){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Purple Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 6){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cyan Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 7){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Gray Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 8){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gray Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 9){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pink Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 10){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Lime Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 11){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Yellow Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 12){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Light Blue Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 13){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Magenta Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 14){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Orange Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 16){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Black Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 17){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Brown Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 18){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Blue Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 351 && $item->getDamage() == 19){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x White Dye§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
       ...
       if($item->getId() == 152 && $item->getDamage() == 0){
        ...
        if($item->getId() == 298 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Leather Helmet§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	     }
        }
        if($item->getId() == 299 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Leather Chestplate§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 300 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Leather Leggings§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 301 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Leather Boots§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 302 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Chainmail Helmet§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 303 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Chainmail Chestplate§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 304 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Chainmail Leggings§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 305 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Chainmail Boots§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 306 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Iron Helmet§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 307 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Iron Chestplate§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 308 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Iron Leggings§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 309 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Iron Boots§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 310 && $item->getDamage() == 0){
	        ...
	        if($money >= 100){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diamond Helmet§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 311 && $item->getDamage() == 0){
	        ...
	        if($money >= 100){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diamond Chestplate§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 312 && $item->getDamage() == 0){
	        ...
	        if($money >= 100){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diamond Leggings§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 313 && $item->getDamage() == 0){
	        ...
	        if($money >= 100){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diamond Boots§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 314 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gold Helmet§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 315 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gold Chestplate§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 316 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gold Leggings§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 317 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gold Boots§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua armor!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	   ...
	   if($item->getId() == 152 && $item->getDamage() == 0){
        ...
        if($item->getId() == 325 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Bucket§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	     }
        }
        if($item->getId() == 325 && $item->getDamage() == 8){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Bucket of Water§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 325 && $item->getDamage() == 10){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Bucket of Lava§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 347 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Clock§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 345 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Compass§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 346 && $item->getDamage() == 0){
	        ...
	        if($money >= 20){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Fishing rod§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 259 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Flint and Steel§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 359 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Shears§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 261 && $item->getDamage() == 0){
	        ...
	        if($money >= 30){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Bow§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 268 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Wooden Sword§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 270 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Wooden Pickaxe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 271 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Wooden Axe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 269 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Wooden Shovel§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 290 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Wooden Hoe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 272 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Stone Sword§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 274 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Stone Pickaxe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 275 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Stone Axe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 273 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Stone Shovel§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 291 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Stone Hoe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 267 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Iron Sword§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 257 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Iron Pickaxe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 258 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Iron Axe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 256 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Iron Shovel§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 292 && $item->getDamage() == 0){
	        ...
	        if($money >= 50){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Iron Hoe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 283 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gold Sword§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 285 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gold Pickaxe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 286 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gold Axe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 284 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gold Shovel§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 294 && $item->getDamage() == 0){
	        ...
	        if($money >= 25){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gold Hoe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 276 && $item->getDamage() == 0){
	        ...
	        if($money >= 100){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diamond Sword§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 278 && $item->getDamage() == 0){
	        ...
	        if($money >= 100){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diamond Pickaxe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 279 && $item->getDamage() == 0){
	        ...
	        if($money >= 100){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diamond Axe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 277 && $item->getDamage() == 0){
	        ...
	        if($money >= 100){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diamond Shovel§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 293 && $item->getDamage() == 0){
	        ...
	        if($money >= 100){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diamond Hoe§7!");
		}else{
	        $sender->sendMessage("§c§Lỗi ! Bạn không đủ tiền để mua items!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
       ...
       if($item->getId() == 160 && $item->getDamage() == 13){
        ...
        if($item->getId() == 295 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Wheat Seeds§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 361 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pumpkin Seeds§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 362 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Melon Seeds§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 458 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Beetroot Seeds§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 391 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Caddot§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 392 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Potato§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 170 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Hayblock§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 86 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pumpkin§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 103 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Melon Block§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 457 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Beetroot§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 338 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Sugarcane§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 260 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Apple§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 296 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Wheat§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 360 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Melon Slice§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 400 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pumpkin Pie§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 81 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cactus§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 39 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Brown Mushroom§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 40 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Red Mushroom§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 6 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Oak Sapling§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 6 && $item->getDamage() == 1){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Spruce Sapling§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 6 && $item->getDamage() == 2){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Birch Sapling§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 6 && $item->getDamage() == 3){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Jungle Sapling§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 6 && $item->getDamage() == 4){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Acacia Sapling§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 6 && $item->getDamage() == 5){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dark Oak Sapling§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 18 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Oak Leaves§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 18 && $item->getDamage() == 1){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Spruce Leaves§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 18 && $item->getDamage() == 2){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Birch Leaves§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 18 && $item->getDamage() == 3){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Jungle Leaves§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 161 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Acacia Leaves§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 161 && $item->getDamage() == 1){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dark Oak Leaves§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	 ...
	 public function decorations($sender)
	 {
        ...
        public function decorationsshop(Player $sender, Item $item) 
        {
	     ...
	     $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_CLICK, (int) $volume);
	        ...
	        if($money >= 100){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Anvil§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 355 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Ber§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 47 && $item->getDamage() == 0){
	        ...
	        if($money >= 7){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Bookshelf§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 379 && $item->getDamage() == 0){
	        ...
	        if($money >= 12){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Brewing Stand§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 380 && $item->getDamage() == 0){
	        ...
	        if($money >= 15){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cauldron§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 54 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Chest§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 58 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Crafting Table§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 23 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dispenser§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 125 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dropper§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 116 && $item->getDamage() == 0){
	        ...
	        if($money >= 250){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Enchanting Table§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 130 && $item->getDamage() == 0){
	        ...
	        if($money >= 75){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Ended Chest§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 390 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Flower Pot§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 389 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Item Frame§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 61 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Furnace§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 410 && $item->getDamage() == 0){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Hopper§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 84 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x JukeBox§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 25 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Noteblock§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 236 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $inv = $sender->getInventory();
		     $inv->addItem(Item::get(236, 0, 1));
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Observer§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 321 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Painting§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 33 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Piston§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 29 && $item->getDamage() == 0){
	        ...
	        if($money >= 8){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Sticky Piston§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 50 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Torch§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 96 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Oak Trapdoor§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 65 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Ladder§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	...
	public function blocks($sender)
	{
        ...
        public function blocksshop(Player $sender, Item $item)
        {
	     ...
	     $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_CLICK, (int) $volume);
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Oak Log§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 17 && $item->getDamage() == 1){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Spruce Log§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 17 && $item->getDamage() == 2){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Birch Log§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 17 && $item->getDamage() == 3){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Jungle Log§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 162 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Acacia Log§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 162 && $item->getDamage() == 1){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dark Oak Log§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 5 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Oak Planks§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 5 && $item->getDamage() == 1){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Spruce Planks§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 5 && $item->getDamage() == 2){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Birch Planks§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 5 && $item->getDamage() == 3){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Jungle Planks§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 5 && $item->getDamage() == 4){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Acacia Planks§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 5 && $item->getDamage() == 5){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dark Oak Planks§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 53 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Oak Stairs§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 134 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Spruce Stairs§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 135 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Birch Stairs§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 136 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Jungle Stairs§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 163 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Acacia Stairs§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 164 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dark Oak Stairs§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 158 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Oak Slab§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 158 && $item->getDamage() == 1){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Spruce Slab§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 158 && $item->getDamage() == 2){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Birch Slab§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 158 && $item->getDamage() == 3){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Jungle Slab§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 158 && $item->getDamage() == 4){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Acacia Slab§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 158 && $item->getDamage() == 5){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dark Oak Slab§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 107 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Oak Fence Gate§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 183 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Spruce Fence Gate§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 184 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Birch Fence Gate§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 185 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Jungle Fence Gate§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 187 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Acacia Fence Gate§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 186 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dark Oak Fence Gate§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 85 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Oak Fence§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 85 && $item->getDamage() == 1){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Spruce Fence§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 85 && $item->getDamage() == 2){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Birch Fence§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 85 && $item->getDamage() == 3){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Jungle Fence§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 85 && $item->getDamage() == 4){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Acacia Fence§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 85 && $item->getDamage() == 5){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dark Oak Fence§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        public function blocks1($sender)
        {
	     ...
	     $inventory = $this->menu->getInventory();
          ...
          $inventory->setItem(51, Item::get(2, 0, 1)->setCustomName("Grass\n\n§7Cost:§a§l⛃§r§a300 §r"));
          $inventory->setItem(52, Item::get(3, 0, 1)->setCustomName("§r§fDirt\n\n§7Cost:§r§a§l⛃§r§a200 §r"));
        ...
        if($item->getId() == 1 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Stone§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 4 && $item->getDamage() == 1){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cobblestone§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 48 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Mossy Cobblestone§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 13 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Gravel§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 98 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Stone Bricks§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 98 && $item->getDamage() == 1){
	        ...
	        if($money >= 4){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Mossy Stone Bricks§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 98 && $item->getDamage() == 2){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Crack Stone Bricks§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 98 && $item->getDamage() == 3){
	        ...
	        if($money >= 4){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Chiseled Stone Bricks§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 121 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x End Stone§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 1 && $item->getDamage() == 1){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Granite§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 1 && $item->getDamage() == 3){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Diorite§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 1 && $item->getDamage() == 5){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Andesite§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 82 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Clay§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 49 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Obsidian§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 87 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Netherrack§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 1 && $item->getDamage() == 2){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Polished Granite§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 1 && $item->getDamage() == 4){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Polished Diorite§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 1 && $item->getDamage() == 6){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Polished Andesite§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 168 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $inv = $sender->getInventory();
		     $inv->addItem(Item::get(1, 0, 1));
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Prismarine§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 168 && $item->getDamage() == 1){
	        ...
	        if($money >= 7){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dark Prismarine§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 168 && $item->getDamage() == 2){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Prismarine Bricks§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 155 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Block of Quartz§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 155 && $item->getDamage() == 1){
	        ...
	        if($money >= 7){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Chiseled Quartz§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 155 && $item->getDamage() == 2){
	        ...
	        if($money >= 10){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Pillar Quartz§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 179 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Red Sandstone§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 179 && $item->getDamage() == 1){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cut Red Sandstone§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 24 && $item->getDamage() == 0){
	        ...
	        if($money >= 2){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Sandstone§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 24 && $item->getDamage() == 1){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Chiseled Sandstone§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 24 && $item->getDamage() == 2){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Cut Sandstone§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 88 && $item->getDamage() == 0){
	        ...
	        if($money >= 3){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Soul Sand§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 46 && $item->getDamage() == 0){
	        ...
	        if($money >= 5){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x TnT§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 12 && $item->getDamage() == 0){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Sand§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 12 && $item->getDamage() == 1){
	        ...
	        if($money >= 1){
		     ...
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Red Sand§7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
        ...
        if($item->getId() == 2 && $item->getDamage() == 0){
	        ...
	        if($money >= 300){
		     ...
		     $inv = $sender->getInventory();
		     $inv->addItem(Item::get(2, 0, 1));
		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Grass §7!");
		}else{
	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	        $volume = mt_rand();
	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
	     ...
	     if($item->getId() == 3 && 
	       $item->getDamage() == 0){
	     	        ...
	     	        if($money >= 200){
	     		     ...
	     		     $inv = $sender->getInventory();
	     		     $inv->addItem(Item::get(3, 0, 1));
	     		     $sender->sendMessage("§a§lThành công ! Bạn đã mua §e1x Dirt§7!");
	     		}else{
	     	        $sender->sendMessage("§c§lLỗi ! Bạn không đủ tiền để mua!");
	     	        $volume = mt_rand();
	     	        $sender->getLevel()->broadcastLevelEvent($sender, LevelEventPacket::EVENT_SOUND_ANVIL_FALL, (int) $volume);
